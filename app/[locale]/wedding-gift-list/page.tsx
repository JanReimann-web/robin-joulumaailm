...
type WeddingGiftListPageProps = {
  params: {
    locale: string
  }
}

const SLUG = 'wedding-gift-list'

export function generateMetadata({ params }: WeddingGiftListPageProps): Metadata {
...
export default async function WeddingGiftListPage({ params }: WeddingGiftListPageProps) {
