...
type PrivateWeddingRegistryPageProps = {
  params: {
    locale: string
  }
}

const SLUG = 'private-wedding-registry'

export function generateMetadata({ params }: PrivateWeddingRegistryPageProps): Metadata {
...
export default async function PrivateWeddingRegistryPage({
  params,
}: PrivateWeddingRegistryPageProps) {
