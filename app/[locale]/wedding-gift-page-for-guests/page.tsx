...
type WeddingGiftPageForGuestsPageProps = {
  params: {
    locale: string
  }
}

const SLUG = 'wedding-gift-page-for-guests'

export function generateMetadata({ params }: WeddingGiftPageForGuestsPageProps): Metadata {
...
export default async function WeddingGiftPageForGuestsPage({
  params,
}: WeddingGiftPageForGuestsPageProps) {
